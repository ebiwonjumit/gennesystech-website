...
const HeroSection: React.FC = () => {
  return (
    <section id="home" className="bg-gray-50 pt-20 pb-16 md:pt-28 md:pb-24">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Custom Software<br />
              <span className="text-primary">Solutions</span> That Work
            </h1>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <Link href="/work">
                <Button className="bg-primary hover:bg-primary/90 text-white font-medium py-3 px-6">
                  View Our Work
                </Button>
              </Link>
              <Link href="/contact">
                <Button variant="outline" className="bg-white hover:bg-gray-50 text-primary border border-primary font-medium py-3 px-6">
                  Get in Touch
                </Button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-70">
            {[1, 2, 3, 4].map((index) => (
              <div key={index} className="flex justify-center">
                <div className="h-10 bg-gray-200 rounded w-32 flex items-center justify-center text-gray-500">
                  Client Logo
                </div>
              </div>
            ))}
